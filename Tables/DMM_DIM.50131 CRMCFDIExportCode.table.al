table 50131 "CRM  CFDI Export Code"
{
    Caption = 'Dataverse CFDI Export Code';
    Description = 'CFDI Export Code';
    Access = Internal;
    TableType = Temporary;
    ...
    begin
        if TableMetadata.Get(Database::"CRM Account") then
            OptionSetMetadataDictionary := CDSIntegrationMgt.GetOptionSetMetadata(TableMetadata.ExternalName, 'dmm_cfdiexportcode');
