table 50129 "CRM SAT Use Code"
{
    Caption = 'Dataverse SAT Use Code';
    Description = 'SAT Use Code';
    Access = Internal;
    TableType = Temporary;
    ...
    begin
        if TableMetadata.Get(Database::"CRM Account") then
            OptionSetMetadataDictionary := CDSIntegrationMgt.GetOptionSetMetadata(TableMetadata.ExternalName, 'dmm_cfdipurpose');
